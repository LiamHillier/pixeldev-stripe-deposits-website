...
export const keys = () =>
  createEnv({
    client: {
      ...
      NEXT_PUBLIC_BILLING_PRICE_BUSINESS_YEAR_ID: z.string().optional()
    },
    server: {
    ...
    runtimeEnv: {
      ...
      NEXT_PUBLIC_BILLING_PRICE_BUSINESS_YEAR_ID:
        process.env.NEXT_PUBLIC_BILLING_PRICE_BUSINESS_YEAR_ID,
